...
"$UE_ROOT/Engine/Build/BatchFiles/RunUAT.sh" BuildCookRun -project="$PROJECT" \
  ...
  -map=/Game/Maps/L_MainMenu+/Game/Maps/L_Sunhollow_Greybox+/Game/Maps/L_Overgrowth_Greybox+/Game/Maps/L_Stillworks_Greybox+/Game/Maps/L_Hush_Greybox+/Game/Maps/L_FirstGarden_Greybox
```
